    ...
    <div class="row g-4 justify-content-center">
        ...
        @php
            $cards = [
                ...
                /*2OQUT 2*/ ['icon' => 'bi-file-earmark-text icon-DocNum',   'titulo' => 'Cotizaciones#',            'texto' => 'Sincroniza los DocNum desde Sap.',                   'servicio' => 'DocNum',                  'ruta1' => '#',                       'ruta2' => '#'],
                /*2ORDR 2*/ ['icon' => 'bi-cart-check icon-DocNumP',         'titulo' => 'Pedidos#',                 'texto' => 'Sincroniza los DocNum desde Sap.',                   'servicio' => 'DocNumP',                 'ruta1' => '#',                       'ruta2' => '#'],
                ...
                /*2ITM1 2*/ ['icon' => 'bi-cash-stack icon-precios',         'titulo' => 'Lista de Precios#',        'texto' => 'Sincroniza los precios de lista.',                   'servicio' => 'Lista_Precios',           'ruta1' => '#',                 'ruta2' => '#'],
                ...
                /*CRD1 2*/ ['icon' => 'bi-geo-alt-fill icon-direcciones',   'titulo' => 'Direcciones de Clientes', 'texto' => 'Sincroniza la dirección de Clientes.',               'servicio' => 'Direcciones',             'ruta1' => 'C:\Users\KOM090\Documents\Nueva\Clientes_Direcciones\Clientes_Direcciones.xml',                 'ruta2' => 'C:\Users\KOM090\Documents\Nueva\Clientes_Direcciones_Actualiza\Clientes_Direcciones_Actualiza.xml'],
                 /*OEDG 2*/ ['icon' => 'bi-tags-fill icon-descuentos',       'titulo' => 'Grupos de Descuentos#',    'texto' => 'Sincroniza grupos de descuentos.',                   'servicio' => 'Grupo_Descuentos',        'ruta1' => 'C:\Users\KOM090\Documents\Nueva\Descuentos\Descuentos.xml',          'ruta2' => '#'],
                /*5EDG1 5*/ ['icon' => 'bi-percent icon-descuento',          'titulo' => 'Descuentos#',              'texto' => 'Sincroniza los descuentos.',                         'servicio' => 'Descuentos_Detalle',      'ruta1' => '#',                       'ruta2' => '#'],
                ...
                /*1stock2*/ ['icon' => 'bi bi-graph-up icon-stock',          'titulo' => 'Stock#',                   'texto' => 'Sincroniza el stock de articulos.',                  'servicio' => 'stock',                   'ruta1' => '#',                                         'ruta2' => '#'],
...
{{--
    /*ORTT 2*/ ['icon' => 'bi-currency-exchange icon-currency', 'titulo' => 'Divisas del Día',         'texto' => 'Sincroniza las divisas del día.',                    'servicio' => 'Cambios_Monedas',         'ruta1' => '#',                                            'ruta2' => 'C:\SFTP_MiKombitec\data\TiposDeCambioActualiza\TiposDeCambioActualiza.xml'],
    /*2OQUT 2*/ ['icon' => 'bi-file-earmark-text icon-DocNum',   'titulo' => 'Cotizaciones#',            'texto' => 'Sincroniza los DocNum desde Sap.',                   'servicio' => 'DocNum',                  'ruta1' => '#',                       'ruta2' => '#'],
    /*2ORDR 2*/ ['icon' => 'bi-cart-check icon-DocNumP',         'titulo' => 'Pedidos#',                 'texto' => 'Sincroniza los DocNum desde Sap.',                   'servicio' => 'DocNumP',                 'ruta1' => '#',                       'ruta2' => '#'],
    ...
    /*2OITB 2*/ ['icon' => 'bi-grid-1x2-fill icon-marcas',       'titulo' => 'Grupos de Artículos#',     'texto' => 'Sincroniza los grupos de artículos o marcas.',       'servicio' => 'Marcas',                  'ruta1' => 'C:\SFTP_MiKombitec\data\Marcas\Marcas.xml',                    'ruta2' => 'C:\SFTP_MiKombitec\data\Marcas_Actualiza\Marcas_Actualiza.xml'],
    ...
    /*1OEDG 2*/ ['icon' => 'bi-tags-fill icon-descuentos',       'titulo' => 'Grupos de Descuentos#',    'texto' => 'Sincroniza grupos de descuentos.',                   'servicio' => 'Grupo_Descuentos',        'ruta1' => 'C:\SFTP_MiKombitec\data\Descuentos\Descuentos.xml',          'ruta2' => '#'],
    /*5EDG1 5*/ ['icon' => 'bi-percent icon-descuento',          'titulo' => 'Descuentos#',              'texto' => 'Sincroniza los descuentos.',                         'servicio' => 'Descuentos_Detalle',      'ruta1' => '#',                       'ruta2' => '#'],
